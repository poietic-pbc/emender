...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-659f7407c1
readonly SOURCE_COMMIT=659f74079b8349db48c6065172c19a47904d8219
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5034029/full-layout-gate.json"
...
readonly RESUME_HANDOFF="$RUN_DIR/handoff/generation-00000007-fence-00000005.json"
readonly FENCE_DB="$RUN_DIR/control/pool-v1.sqlite3"
readonly BULK_ROOT=/tmp/resilient-e97-4n-20260720T030512Z
readonly KERNEL_CACHE_ROOT=/tmp/resilient-e97-4n-kernel-cache-20260720T030512Z
...
[[ $(sha256sum "$RESUME_HANDOFF" | awk '{print $1}') == 9fb5bc22aa5afca24cabcf1bcabafac40d7e63edda80757d8015f0903e771bc7 ]]
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 5 ]]
[[ $(sqlite3 "$FENCE_DB" "select count(*) from leases where run_id='$RUN_ID';") == 0 ]]
[[ $(sqlite3 "$FENCE_DB" "select fence || ':' || json_extract(payload, '\$.generation') || ':' || json_extract(payload, '\$.accepted_tokens') from publications where run_id='$RUN_ID' and kind='latest' and name='authoritative';") == 5:7:47208960 ]]
