...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-d31fbbcb17
readonly SOURCE_COMMIT=d31fbbcb5e18f69e3d566582d1bd94a5edec1911
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5034592/full-layout-gate.json"
...
readonly BULK_ROOT=/tmp/e8-f12-064800
readonly KERNEL_CACHE_ROOT=/tmp/e8-k-f12-064800
...
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 11 ]]
