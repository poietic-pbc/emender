...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-19ad08c6a4
readonly SOURCE_COMMIT=19ad08c6069f2eae865421b0904746b45a26a4c0
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5035136/full-layout-gate.json"
...
readonly BULK_ROOT=/tmp/e32-f18-clean-105500
readonly KERNEL_CACHE_ROOT=/tmp/e32-k-f18-clean-105500
...
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 17 ]]
