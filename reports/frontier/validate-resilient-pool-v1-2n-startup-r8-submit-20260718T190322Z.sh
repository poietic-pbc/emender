...
RUN_ID=validate-resilient-pool-v1-2n-startup-r8-20260718T190322Z-077da1e
RUN_DIR=/lustre/orion/bif148/proj-shared/emender/runs/$RUN_ID
CODE_COMMIT=077da1e76f5d4728e90ef6c9be3d131d738812e8
...
verify_sha256 4b1c3c27840d56ed73672092fd4181ea91ed052b79fe700fd7ffc8d29feedcd5 "$REPO/scripts/frontier/resilient_e97_allocation_supervisor.py"
verify_sha256 02bd039c31800810751e7892cad8810758397be55713208958074d8d7159105e "$REPO/scripts/frontier/resilient_e97_role.py"
