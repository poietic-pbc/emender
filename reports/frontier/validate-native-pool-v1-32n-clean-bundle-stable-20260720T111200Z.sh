...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-3ef0610ae7
readonly SOURCE_COMMIT=3ef0610a82a217f4e0235df5d1da6c18ec81d57b
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5035213/full-layout-gate.json"
...
readonly RESUME_HANDOFF="$RUN_DIR/handoff/generation-00000014-fence-00000016.json"
readonly FENCE_DB="$RUN_DIR/control/pool-v1.sqlite3"
readonly BULK_ROOT=/tmp/e32-f19-clean-111200
readonly KERNEL_CACHE_ROOT=/tmp/e32-k-f19-clean-111200
...
[[ $(sha256sum "$RESUME_HANDOFF" | awk '{print $1}') == 31693c27af8b9eb18616dfb9c41cc71e5b6d5410288ca7c37a2a94f00550405a ]]
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 18 ]]
[[ $(sqlite3 "$FENCE_DB" "select count(*) from leases where run_id='$RUN_ID';") == 0 ]]
[[ $(sqlite3 "$FENCE_DB" "select fence || ':' || json_extract(payload, '\$.generation') || ':' || json_extract(payload, '\$.accepted_tokens') from publications where run_id='$RUN_ID' and kind='latest' and name='authoritative';") == 16:14:152117760 ]]
