...
readonly BULK_ROOT=/tmp/resilient-e97-8n-progress-20260720T044839Z
readonly KERNEL_CACHE_ROOT=/tmp/resilient-e97-8n-progress-kernel-cache-20260720T044839Z
...
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 9 ]]
