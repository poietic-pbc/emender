...
readonly REPO
readonly SOURCE_COMMIT=85cf5a09eae00f19612e30b4b7001cab0e1a541f
readonly STAMP=20260719T192710Z
readonly RUN_ID=validate-native-pool-v1-2n-startup-${STAMP}-${SOURCE_COMMIT:0:7}
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5033120/full-layout-gate.json"
...
[[ $(git -C "$REPO" rev-parse origin/main) == "$SOURCE_COMMIT" ]]
