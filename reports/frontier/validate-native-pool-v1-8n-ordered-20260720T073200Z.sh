...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-a8f8a93a55
readonly SOURCE_COMMIT=a8f8a93a6e19bfd4058847731bf491242fa6828b
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5034651/full-layout-gate.json"
...
readonly BULK_ROOT=/tmp/e8-f13-073200
readonly KERNEL_CACHE_ROOT=/tmp/e8-k-f13-073200
...
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 12 ]]
