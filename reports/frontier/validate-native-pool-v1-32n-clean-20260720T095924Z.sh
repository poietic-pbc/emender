...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-48b280b7a0
readonly SOURCE_COMMIT=48b280b78b15fd9fb7230f99d21f19a37ad6d8dd
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5035009/full-layout-gate.json"
...
readonly BULK_ROOT=/tmp/e32-f17-clean-095924
readonly KERNEL_CACHE_ROOT=/tmp/e32-k-f17-clean-095924
...
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 16 ]]
