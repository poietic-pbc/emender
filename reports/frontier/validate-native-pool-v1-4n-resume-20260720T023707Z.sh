...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-10c6fd4181
readonly SOURCE_COMMIT=10c6fd418159d419bcdc4c92942d472f01e5401c
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5033900/full-layout-gate.json"
...
readonly RESUME_HANDOFF="$RUN_DIR/handoff/generation-00000006-fence-00000004.json"
readonly FENCE_DB="$RUN_DIR/control/pool-v1.sqlite3"
readonly BULK_ROOT=/tmp/resilient-e97-4n-20260720T023707Z
readonly KERNEL_CACHE_ROOT=/tmp/resilient-e97-4n-kernel-cache-20260720T023707Z
...
[[ $(sha256sum "$RESUME_HANDOFF" | awk '{print $1}') == 94ac4c7c4155f985d6bfbc96596433f32ed512e4b1c3d38ada72c8b242bf0f2c ]]
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 4 ]]
[[ $(sqlite3 "$FENCE_DB" "select count(*) from leases where run_id='$RUN_ID';") == 0 ]]
[[ $(sqlite3 "$FENCE_DB" "select fence || ':' || json_extract(payload, '\$.generation') || ':' || json_extract(payload, '\$.accepted_tokens') from publications where run_id='$RUN_ID' and kind='latest' and name='authoritative';") == 4:6:36718080 ]]
