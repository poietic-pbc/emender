...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-a8885e432a
readonly SOURCE_COMMIT=a8885e43a1ba1ee5c9cd40dcffa5211551fc3aae
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5033751/full-layout-gate.json"
...
readonly RESUME_HANDOFF="$RUN_DIR/handoff/generation-00000005-fence-00000002.json"
readonly FENCE_DB="$RUN_DIR/control/pool-v1.sqlite3"
readonly BULK_ROOT=/tmp/resilient-e97-4n-20260720T020000Z
readonly KERNEL_CACHE_ROOT=/tmp/resilient-e97-4n-kernel-cache-20260720T020000Z
...
[[ $(sha256sum "$RESUME_HANDOFF" | awk '{print $1}') == 0b0ed65a87a796c56ff267db52dff4fd2f843b7ac9c9ffc8211c97fba770c51c ]]
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 3 ]]
[[ $(sqlite3 "$FENCE_DB" "select count(*) from leases where run_id='$RUN_ID';") == 0 ]]
[[ $(sqlite3 "$FENCE_DB" "select fence || ':' || json_extract(payload, '\$.generation') || ':' || json_extract(payload, '\$.accepted_tokens') from publications where run_id='$RUN_ID' and kind='latest' and name='authoritative';") == 2:5:26227200 ]]
