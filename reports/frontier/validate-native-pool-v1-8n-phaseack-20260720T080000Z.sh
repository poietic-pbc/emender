...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-9504924141
readonly SOURCE_COMMIT=95049241c354464ce4ee0a1b8ea530f6f95f68ab
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5034732/full-layout-gate.json"
...
readonly BULK_ROOT=/tmp/e8-f14-080000
readonly KERNEL_CACHE_ROOT=/tmp/e8-k-f14-080000
...
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 13 ]]
