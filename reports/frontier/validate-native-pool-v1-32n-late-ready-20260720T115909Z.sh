...
readonly REPO=/lustre/orion/bif148/proj-shared/emender/source-snapshots/emender-6d2a62269a
readonly SOURCE_COMMIT=6d2a62263da9fdb7eb5aa569f8021344bb0d2056
...
readonly G2_GATE="$REPO/reports/frontier/native-dataplane/5035280/full-layout-gate.json"
...
readonly BULK_ROOT=/tmp/e32-f21-late-115909
readonly KERNEL_CACHE_ROOT=/tmp/e32-k-f21-late-115909
...
[[ $(sqlite3 "$FENCE_DB" "select last_fence from lease_epochs where run_id='$RUN_ID';") == 20 ]]
