...
| Full 513B-seed packed-model step | RETRY | job 5182344 loaded the exact 5,750,016,656-parameter shard at 11.54 GB HBM then failed closed because compute nodes attempted an uncached tokenizer fetch; runner now requires the shared offline p50k cache. Job 5182195 was the corrected import failure; 5182120 was cancelled at zero runtime after source advanced |
