...
| **Fixed; awaiting physical validation** | Code/local/native/formal tests pass, but no qualifying physical job on that exact execution identity has established the behavior. |
