...
ASYNC_STEPS=${ASYNC_STEPS:-$((ASYNC_GENERATIONS * ASYNC_LOCAL_STEPS))}
if [[ "$ASYNC_STEPS" -ne $((ASYNC_GENERATIONS * ASYNC_LOCAL_STEPS)) ]]; then
  echo "ASYNC_STEPS must equal ASYNC_GENERATIONS * ASYNC_LOCAL_STEPS" >&2
  exit 64
fi
