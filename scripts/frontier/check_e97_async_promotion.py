...
def normalized(bundle,policy):
    ...
    allowed_vars={"BASH_SOURCE[0]","SLURM_SUBMIT_DIR:?","SLURM_SUBMIT_DIR","SLURM_JOB_ID:?","SLURM_JOB_ID","SLURM_JOB_ID:-unset","TMPDIR:-/tmp","SLURM_NODELIST","SLURM_NODELIST:?","RUN_ID","RUN_DIR","METRICS","HELPER","IPC","SLURM_PROCID:?missing SLURM_PROCID","COORDINATOR_HOST","COORDINATOR_PORT","BASH_LINENO[0]","E97_STOP_BEFORE_SRUN:-0"}
