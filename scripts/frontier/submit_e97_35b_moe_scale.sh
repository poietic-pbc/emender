...
export_args="ALL,SOURCE_COMMIT=$SOURCE_COMMIT,RUN_ID=$RUN_ID,RUN_ROOT=$RUN_ROOT,TRAIN_MINUTES=$TRAIN_MINUTES,MAX_STEPS=$MAX_STEPS,EXPECTED_NODES=$NODES,EXPECTED_PARTITION=batch,EXPECTED_QOS=$QOS,EXPECTED_TIME_LIMIT=$TIME_LIMIT,SAMPLER_SCHEMA=$SAMPLER_SCHEMA,SAMPLER_CORPUS_SHA256=$SAMPLER_CORPUS_SHA256,SAMPLER_TOKENIZER_SHA256=$SAMPLER_TOKENIZER_SHA256,SAMPLER_KEY=$SAMPLER_KEY,SAMPLER_DATA_WORLD_SIZE=$SAMPLER_DATA_WORLD_SIZE,SAMPLER_STREAM_ORIGIN_ACCEPTED_TOKENS=$SAMPLER_STREAM_ORIGIN_ACCEPTED_TOKENS,SAMPLER_TRANSITION_FROM_LEGACY=$SAMPLER_TRANSITION_FROM_LEGACY"
